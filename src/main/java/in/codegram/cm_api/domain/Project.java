package in.codegram.cm_api.domain;
...
public class Project {
	...
	@NotBlank(message="project identifier can not be empty")
	@Size(min=4,max=5,message="project identifier must be in the range of 4 to 5 character")
